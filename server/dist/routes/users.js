...
router.post("/:id/favorites", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
...
router.delete("/:id/favorites/:barberId", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
